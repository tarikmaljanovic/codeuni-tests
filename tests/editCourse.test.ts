...
test('editCourse', async () => {
    await landingPage.enterEmailLogin(testData.admin_data.email);
    await landingPage.enterPasswordLogin(testData.admin_data.password);
    await landingPage.clickLoginButton();
    await dashboardPage.clickOnCourseButton();
    await coursePage.clickLessonTitle();
    await lessonPage.changeLessonContent();
    await lessonPage.clickInsertButton();
    await lessonPage.clickLogoutButton();
    ...
    await dashboardPage.clickOnCourseButton();
    await coursePage.clickLessonTitle();
    await lessonPage.checkCourseContent();
